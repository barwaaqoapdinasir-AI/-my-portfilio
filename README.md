# 💼 barwaaqo apdinasir's Portfolio

> A stunning, premium portfolio website with next-level animations showcasing my work as a Frontend Developer.

[![GitHub](https://img.shields.io/badge/GitHub-Profile-black?style=for-the-badge&logo=github)](ttps://github.com/barwaaqoapdinasir-Al)
[![Email](https://img.shields.io/badge/Email-Contact-EA4335?style=for-the-badge&logo=gmail)](mailto:barwaaqoapdinasir@gmail.com
...
1. **Clone or download the repository**
   ```bash
   git clone https://github.com/barwaaqoapdinasir-Al/portfolia.sample.git
   cd portfolia.sample
   ```
...
```javascript
const GITHUB_USERNAME = 'barwaaqoapdinasir-Al';
```

### Change Email
Update in `index.html`:
```html
<a href="mailto:barwaaqoapdinasir@gmail.com">arwaaqoapdinasir@gmail.com</a>
```
...
- **Email**: [barwaaqoapdinasir@gmail.com](mailto:barwaaqoapdinasir@gmail.com])
- **GitHub**: [github.com/barwaaqoapdinasir-Al](https://github.com/barwaaqoapdinasir-Al)
